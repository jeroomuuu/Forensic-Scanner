...
# CSG materials and library_data (exactly as in your 1.5b)
...
def build_geometry_and_settings(beam_mode="fan", use_csg=False, mystery_mat=None):
    # ... your exact CSG geometry code from 1.5b ...
    # (kept 100% identical)
    ...
...
def build_tallies(detector_cell, use_layers=False, use_delayed_low=False):
    # ... your exact tally code from 1.5b ...
...
def bayesian_nnfl_analysis(x_nnls, Matrix_A, labels, prior_alpha=1.0):
    ...
    alpha_post = alpha_prior + x_nnls * 1000.0
...
def plot_pftna_spectra(mean_g, gamma_energies, mystery_target_name, mean_low=None):
    # ... your exact plot code from 1.5b with the bigger inset and colored bands ...
    ...

def plot_layered_flux(...): ...   # unchanged
def plot_3d_beam_geometry(...): ...   # unchanged
...
def main():
    parser = argparse.ArgumentParser(
        description="🧠 Forensic Scanner V1.7\nPulsed D-T + 5D Layered + Delayed Low-Energy X-rays + Bayesian NNFL",
